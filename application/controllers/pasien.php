...
class Pasien extends MY_Controller {
    ...
    public function cetak_laporan() {
        ...
        $kategori = $this->input->post('kategori'); // status dikirim dari form input manual
    
        $data['pasien'] = $this->pasien_model->get_laporan_pasien($tanggal_dari, $tanggal_sampai, $kategori);
